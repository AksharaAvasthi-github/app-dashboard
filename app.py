...
orders = pd.read_csv("/content/cost_breakdown.csv")
vehicles = pd.read_csv("/content/customer_feedback.csv")
warehouses = pd.read_csv("/content/delivery_performance.csv")
delivery_perf = pd.read_csv("/content/orders.csv")
traffic_weather = pd.read_csv("/content/routes_distance.csv")
costs = pd.read_csv("/content/vehicle_fleet.csv")
carbon = pd.read_csv("/content/warehouse_inventory.csv")
